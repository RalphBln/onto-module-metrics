 ...
 *
 * <p>The class is a drop-in replacement for <CODE>ImageIcon</CODE>, except that the no-argument
 * constructor is not supported.
 *
 * <p>As the size of the Icon is determined by the size of the component in which it is displayed,
...
public class StretchIcon extends ImageIcon {
   ...
   *
   * <p>If the proportion has not been specified, or has been specified as <code>true</code>, the
   ...
   *
   * <p>If this icon has no image observer,this method uses the <code>c</code> component as the
   * observer.
   *
